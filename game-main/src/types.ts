...
export interface SiteConfig {
  ...
  customPages?: Record<string, any>; overviewItems?: {label:string;url:string;enabled?:boolean}[]; joinSettings?: Record<string,any>; volunteerSettings?: Record<string,any>;
}
