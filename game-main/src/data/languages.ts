...
export const languages: LanguageDefinition[] = [
  {code:'en',name:'English',nativeName:'English',icon:'🇬🇧',status:'active',direction:'ltr',accent:'#3b82f6',tts:'en-US',scripts:['Latin'],frameworks:['CEFR','THCS/THPT'],specialties:['Phonics','Stress','Collocation','Workplace English']},
  ...
  {code:'vi',name:'Vietnamese',nativeName:'Tiếng Việt',icon:'🇻🇳',status:'active',direction:'ltr',accent:'#14b8a6',tts:'vi-VN',scripts:['Latin'],frameworks:['THCS/THPT','Practical'],specialties:['Chính tả','Ngữ pháp','Giao tiếp']},
