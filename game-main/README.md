...
- **D1 binding:** `GAME_DB`
- `database_name` trong `wrangler.jsonc` đang đặt là `sky-first-games`; nếu tên hiển thị thật trong Cloudflare Dashboard khác, đổi duy nhất trường này, giữ nguyên database ID.
- **R2 bucket:** `game`
